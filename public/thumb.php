...
define('THUMB_CACHE_AGE',       864000);         // Duration of cached files in seconds
...
define('JPEG_QUALITY',          80);           // Quality of generated JPEGs (0 - 100; 100 being best)
...
$zoom = isset($_GET['zoom']) ? max(0, min(1, $_GET['zoom'])) : 1;
